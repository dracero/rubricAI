...
class step4 {
    ...
    public static function render(array $ctx): void {
        ...
        echo html_writer::tag('p', 'Instrumentos sugeridos por RubricAI', ['class' => 'rubricai-stitle']);
        echo html_writer::tag('p',
            'RubricAI te sugerirá un conjunto de instrumentos de evaluación justificados pedagógicamente y basados en tu(s) objetivo(s).',
        ...
        if (empty($sugs)) {
            ...
            echo html_writer::tag('p',
                'Hacé clic para que RubricAI analice tu(s) objetivo(s) y te sugiera los instrumentos de evaluación',
            ...
            echo html_writer::link($gen_url, '✨ Generar sugerencias con RubricAI', [
            ...
            if (!empty($effective_sel)) {
                ...
                echo html_writer::tag('strong', '✨ ¿Deseas ajustar estas opciones? Pide un cambio a RubricAI:', ['style' => 'display:block; margin-bottom:10px; font-size:12px; color:#854f0b;']);
        ...
        if ($effective_sel) {
            if ($confirmed || $effective_sel === $instrument) {
                ...
                $btn_attrs = ['class' => 'rubricai-btn rubricai-btn-primary'];
    ...
    private static function generate_suggestions(
        ...
        $err = $res_data->message ?? 'Error en el servicio de RubricAI.';
