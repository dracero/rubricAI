...
class step6 {
    ...
    private static function render_crit(array $ctx): void {
        ...
        if (empty($instrument)) {
            echo html_writer::tag('p', 'Selecciona el instrumento de corrección', ['class' => 'rubricai-stitle']);
            ...
            echo html_writer::link($eval_url, 'Ir a Crear evaluación →', ['class' => 'rubricai-btn rubricai-btn-primary', 'style' => 'margin-top:10px;']);
        ...
        echo html_writer::tag('p', 'Selecciona y genera el instrumento de corrección', ['class' => 'rubricai-stitle']);
            ...
            foreach ($all_types as $type_key) {
                ...
                if ($is_valid) {
                    ...
                    echo html_writer::start_tag('a', [
                        ...
                        'class' => 'rubricai-btn rubricai-btn-primary sug-card',
                        'data-ia' => '1',
        ...
        echo html_writer::start_tag('div', ['class' => 'rubricai-card', 'style' => 'background:#fffcf5; border:1px solid #faeeda; padding:15px; margin-bottom:20px;']);
        echo html_writer::tag('strong', '✨ ¿Deseas ajustar este instrumento? Pide un cambio a RubricAI:', ['style' => 'display:block; margin-bottom:10px; font-size:12px; color:#854f0b;']);
    ...
    private static function render_eval(array $ctx): void {
        ...
        echo html_writer::tag('p', 'Estructura técnica del instrumento generado', ['class' => 'rubricai-stitle']);
        echo html_writer::tag('p', 
        ...
        if (empty($selection_raw)) {
            ...
            echo html_writer::start_tag('div', ['class' => 'rubricai-card', 'style' => 'background:#2d2d2d; border:none; padding:0; border-radius:12px; overflow:hidden; margin-bottom:20px;']);
